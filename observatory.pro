...
;; I Copied the observatory script to put in my own telescopes
;+
; NAME:
;       OBSERVATORY
; PURPOSE:
...
;  'hbo': Hortung-Boothroyd Observatory at Cornell
;
; PROCEDURE CALLS:
;    TEN()             
; REVISION HISTORY:
...
"dct":  begin
 ...
 "hbo": begin
	...
	longitude = [76,23,4.59]
	latitude = [42,27,29.61]
	altitude = 530.0
	tz = 5
        end
 "gemsouth": begin
	name = "Gemini South Observatory"
	longitude = [70,44,12.096]
	latitude = [-30,14,26.70]
	altitude = 2722.0
	tz = 4
        end
